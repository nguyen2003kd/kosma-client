...
export default function SolutionCard({ post, categoryName, locale = "en-US", categoryLink }: SolutionCardProps) {
  const { t } = useTranslation("pages/solutions");
  const resolvedCategoryLink = post.category?.link || categoryLink || "/solutions";
