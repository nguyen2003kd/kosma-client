        ...
        <div className="container-kosmo">
          <div className="max-w-xl mx-auto">
            <Input
              ...
              className="h-14 rounded-full !bg-white/10 border-white/40 !text-white placeholder:text-white/70"
            />
          </div>
        </div>
      </section>
              ...
              <div key={`${location.city}-${location.state}`} className="p-6 rounded-[--radius-md] border border-line bg-white hover:shadow-soft transition-shadow">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a href={`tel:${location.phone}`} className="text-[14px] text-gray-700 hover:text-black-800">{location.phone}</a>
                  </div>
                </div>
              </div>
            ))}
