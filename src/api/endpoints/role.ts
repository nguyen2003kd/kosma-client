...
export const getGetApiV10RoleIdInfiniteQueryOptions = <TData = InfiniteData<Awaited<ReturnType<typeof getApiV10RoleId>>>, TError = void>(id: string, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiV10RoleId>>, TError, TData>>, }
) => {
...
export type GetApiV10RoleIdInfiniteQueryError = void


export function useGetApiV10RoleIdInfinite<TData = InfiniteData<Awaited<ReturnType<typeof getApiV10RoleId>>>, TError = void>(
...
export function useGetApiV10RoleIdInfinite<TData = InfiniteData<Awaited<ReturnType<typeof getApiV10RoleId>>>, TError = void>(
 id: string, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiV10RoleId>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseInfiniteQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get role by ID
 ...
 * @summary Get role by ID
 */
export const prefetchGetApiV10RoleIdInfiniteQuery = async <TData = Awaited<ReturnType<typeof getApiV10RoleId>>, TError = void>(
 queryClient: QueryClient, id: string, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiV10RoleId>>, TError, TData>>, }
 ...
 * @summary Get role by ID
 */
export const prefetchGetApiV10RoleIdQuery = async <TData = Awaited<ReturnType<typeof getApiV10RoleId>>, TError = void>(
 queryClient: QueryClient, id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiV10RoleId>>, TError, TData>>, }
...
export const getGetApiV10RoleInfiniteQueryOptions = <TData = InfiniteData<Awaited<ReturnType<typeof getApiV10Role>>>, TError = void>(params?: GetApiV10RoleParams, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiV10Role>>, TError, TData>>, }
) => {
...
export type GetApiV10RoleInfiniteQueryError = void


export function useGetApiV10RoleInfinite<TData = InfiniteData<Awaited<ReturnType<typeof getApiV10Role>>>, TError = void>(
...
export function useGetApiV10RoleInfinite<TData = InfiniteData<Awaited<ReturnType<typeof getApiV10Role>>>, TError = void>(
 params?: GetApiV10RoleParams, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiV10Role>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseInfiniteQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get all roles
 ...
 * @summary Get all roles
 */
export const prefetchGetApiV10RoleInfiniteQuery = async <TData = Awaited<ReturnType<typeof getApiV10Role>>, TError = void>(
 queryClient: QueryClient, params?: GetApiV10RoleParams, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiV10Role>>, TError, TData>>, }
 ...
 * @summary Get all roles
 */
export const prefetchGetApiV10RoleQuery = async <TData = Awaited<ReturnType<typeof getApiV10Role>>, TError = void>(
 queryClient: QueryClient, params?: GetApiV10RoleParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiV10Role>>, TError, TData>>, }
