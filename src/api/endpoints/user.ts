...
export const getGetApiV10UserIdInfiniteQueryOptions = <TData = InfiniteData<Awaited<ReturnType<typeof getApiV10UserId>>>, TError = void>(id: string, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiV10UserId>>, TError, TData>>, }
) => {
...
export type GetApiV10UserIdInfiniteQueryError = void


export function useGetApiV10UserIdInfinite<TData = InfiniteData<Awaited<ReturnType<typeof getApiV10UserId>>>, TError = void>(
...
export function useGetApiV10UserIdInfinite<TData = InfiniteData<Awaited<ReturnType<typeof getApiV10UserId>>>, TError = void>(
 id: string, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiV10UserId>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseInfiniteQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get user by ID
 ...
 * @summary Get user by ID
 */
export const prefetchGetApiV10UserIdInfiniteQuery = async <TData = Awaited<ReturnType<typeof getApiV10UserId>>, TError = void>(
 queryClient: QueryClient, id: string, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiV10UserId>>, TError, TData>>, }
 ...
 * @summary Get user by ID
 */
export const prefetchGetApiV10UserIdQuery = async <TData = Awaited<ReturnType<typeof getApiV10UserId>>, TError = void>(
 queryClient: QueryClient, id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiV10UserId>>, TError, TData>>, }
...
export const getGetApiV10UserInfiniteQueryOptions = <TData = InfiniteData<Awaited<ReturnType<typeof getApiV10User>>>, TError = unknown>(params?: GetApiV10UserParams, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiV10User>>, TError, TData>>, }
) => {
...
export type GetApiV10UserInfiniteQueryError = unknown


export function useGetApiV10UserInfinite<TData = InfiniteData<Awaited<ReturnType<typeof getApiV10User>>>, TError = unknown>(
...
export function useGetApiV10UserInfinite<TData = InfiniteData<Awaited<ReturnType<typeof getApiV10User>>>, TError = unknown>(
 params?: GetApiV10UserParams, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiV10User>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseInfiniteQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get all user
 ...
 * @summary Get all user
 */
export const prefetchGetApiV10UserInfiniteQuery = async <TData = Awaited<ReturnType<typeof getApiV10User>>, TError = unknown>(
 queryClient: QueryClient, params?: GetApiV10UserParams, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiV10User>>, TError, TData>>, }
 ...
 * @summary Get all user
 */
export const prefetchGetApiV10UserQuery = async <TData = Awaited<ReturnType<typeof getApiV10User>>, TError = unknown>(
 queryClient: QueryClient, params?: GetApiV10UserParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiV10User>>, TError, TData>>, }
