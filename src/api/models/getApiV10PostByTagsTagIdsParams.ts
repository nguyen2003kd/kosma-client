...
import type { GetApiV10PostByTagsTagIdsFilterBy } from './getApiV10PostByTagsTagIdsFilterBy';

export type GetApiV10PostByTagsTagIdsParams = {
/**
 ...
 */
filterBy?: GetApiV10PostByTagsTagIdsFilterBy;
};
